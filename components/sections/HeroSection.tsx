        ...
        <div className="@container">
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8 @lg:gap-12 items-center">
            ...
            <div className="@container/hero space-y-4 @md/hero:space-y-6">
              ...
              <div className="relative top-8 div_social">
                <Link
                  href={"https://www.instagram.com/pfc.mindset/"}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 @md/hero:px-6 @md/hero:py-3 rounded-lg hover:bg-accent transition-colors text-sm @md/hero:text-base button_social"
                >
                  Instagram
                </Link>
              </div>
