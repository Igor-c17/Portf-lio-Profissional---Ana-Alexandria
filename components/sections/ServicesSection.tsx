                ...
                {featured.map((service) => (
                  ...
                  >
                    ...
                    {service.features && service.features.length > 0 && (
                      <div className="mb-6">
                        <h4 className="font-semibold mb-3 text-sm @md/card:text-base text-muted-foreground">
                    ...
                    <div className="grid grid-cols-1 @xs/card:grid-cols-2 gap-4 mb-6 pt-4 border-t">
                      ...
                      {service.timeline && (
                        <div>
                          ...
                          <p className="font-semibold text-sm @md/card:text-base text-muted-foreground">
                            {service.timeline}
                          </p>
                        </div>
                      )}
                    ...
                    <div>
                      <button
                        type="submit"
                        className="text-muted-foreground rounded-full px-4 py-2 border-white border mb-7"
                      >
